    ...
    <div class="span9">
        <form action="meddelanden_signup.php" method="POST">
            <table>
                ...
                <tr>
                    <td><span class="error"> * <?php echo $headlineErr; ?></span>
                         <br>
                        <input type="text" id="headline" name="headline" class="span6" size="100" value="<?php echo $headline; ?>"/></td>
                </tr>
                ...
                <tr>
                    <td><span class="error"> * <?php echo $contentErr; ?></span>
